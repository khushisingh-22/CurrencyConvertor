        ...
        <div className="w-full max-w-md mx-auto border border-gray-60 rounded-lg p-5 backdrop-blur-sm bg-white/30">
          ...
          >
            ...
            <div className="relative w-full h-0.5">
              <button
                type="button"
                className="absolute left-1/2 -translate-x-1/2 -translate-y-1/2 border-2 border-white rounded-md bg-blue-600 text-white px-2 py-0.5 0 bg-green-500 text-white px-4 py-2 rounded 
            ...
            <button
              type="submit"
              className="w-full bg-blue-600 text-white px-4 py-3 rounded-lg relative px-5 py-2 rounded border border-gray-400
               hover:border-red-500 hover:shadow-red-500/50
